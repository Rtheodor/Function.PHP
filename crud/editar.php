...
<body>
    ...
    if (!empty($dados['SendUpUsuario'])) {
        ...
        try {
            ...
            if ($up_usuario->execute()) {
                ...
                $_SESSION['msg'] = "<p style='color: green;'>Usuario editado com sucesso<br></p>";
                header("Location: index.php");
            } else {
                echo "Ocorreu um erro ao tentar editar usuario";
                $_SESSION['msg'] = "<p style='color: red;'>Usuario não editado com sucesso<br></p>";
                header("Location: index.php");
            }
    ...
    LIMIT 1";
        ...
        $_SESSION['msg'] = "<p style='color: purple;'>Erro: Ocorreu um erro ao tentar editar usuario<br></p>";
        header("Location: index.php");
